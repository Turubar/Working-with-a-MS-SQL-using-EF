...
details_passport NVARCHAR(11) NOT NULL,
date_of_birth DATE NOT NULL,
country_of_birth NVARCHAR(100) NOT NULL,
residency NVARCHAR(150) DEFAULT ('Not defined'),
number_phone NVARCHAR(12) DEFAULT ('Not defined'),
email NVARCHAR(100) DEFAULT ('Not defined'))
GO
...
id_company BIGINT NOT NULL, FOREIGN KEY (id_company) REFERENCES Company (id) ON DELETE CASCADE)
GO

CREATE TABLE Employment_contracts (
id BIGINT PRIMARY KEY IDENTITY NOT NULL,
date_of_conclusion DATE NOT NULL,
id_employee BIGINT NOT NULL, FOREIGN KEY (id_employee) REFERENCES Employee (id) ON DELETE CASCADE,
id_position BIGINT NOT NULL, FOREIGN KEY (id_position) REFERENCES Company_positions (id) ON DELETE CASCADE)
GO
